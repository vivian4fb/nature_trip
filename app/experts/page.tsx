...
export default function ExpertsPage() {
  return (
    <div className="min-h-screen">
            ...
            {experts.map((expert, index) => (
              ...
              >
                <div className="md:w-1/3">
                  <div className="w-48 h-48 bg-gradient-to-br from-[#4f8a6b] to-[#1a4d2e] rounded-full mx-auto"></div>
                </div>
                <div className="md:w-2/3">
                  <h3 className="text-3xl font-bold mb-2 text-[#1a4d2e]">{expert.name}</h3>
                  <p className="text-lg text-[#4f8a6b] font-semibold mb-2">{expert.qualifications}</p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-8 text-center text-[#1a4d2e]">Why Expert Guides Matter</h2>
