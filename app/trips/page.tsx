  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {trips.map((trip) => (
              <div key={trip.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                <div className="h-56 bg-gradient-to-br from-[#eab308] to-[#ca8a04]"></div>
                <div className="p-6">
                  <h3 className="text-2xl font-semibold mb-3 text-[#ca8a04]">{trip.title}</h3>
                  ...
                  <div className="text-2xl font-bold text-[#ca8a04] mb-4">{trip.price}</div>

                  <Link
                    href={`/trips/${trip.id}`}
                    className="block text-center bg-[#fcd34d] text-white px-4 py-3 rounded hover:bg-[#fbbf24] transition-colors font-semibold"
                  >
                    View Full Itinerary
                  </Link>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6 text-[#ca8a04]">Need a Custom Trip?</h2>
          ...
          <Link
            href="/contact"
            className="inline-block bg-[#fcd34d] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#fbbf24] transition-colors"
          >
