...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-r from-[#1a4d2e] to-[#4f8a6b] text-white">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/trips"
              className="bg-[#e67e22] text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-[#d35400] transition-colors"
            >
              View Upcoming Trips
            </Link>
            <Link
              href="/contact"
              className="bg-white text-[#1a4d2e] px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-colors"
            >
              Request Itinerary
            </Link>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-[#e67e22] mb-2">25+</div>
              <div className="text-gray-700">Years of Field Tours</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#e67e22] mb-2">UNESCO</div>
              <div className="text-gray-700">Biodiversity Hotspot</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#e67e22] mb-2">Endemic</div>
              <div className="text-gray-700">Species Focus</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#e67e22] mb-2">10-12</div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center mb-12 text-[#1a4d2e]">
            Why We&apos;re Different
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#4f8a6b] rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {trips.map((trip) => (
              <div key={trip.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                <div className="h-48 bg-gradient-to-br from-[#4f8a6b] to-[#1a4d2e]"></div>
                <div className="p-6">
                  <h3 className="text-xl font-semibold mb-2 text-[#1a4d2e]">{trip.title}</h3>
                  ...
                  <div className="space-y-2 text-sm text-gray-700 mb-4">
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      {trip.focus.map((focus, idx) => (
                        <span key={idx} className="bg-[#4f8a6b] text-white text-xs px-2 py-1 rounded">
                          {focus}
                        </span>
                      ))}
                    </div>
                  ...
                  <Link
                    href={`/trips/${trip.id}`}
                    className="block text-center bg-[#e67e22] text-white px-4 py-2 rounded hover:bg-[#d35400] transition-colors"
                  >
                    Learn More
                  </Link>
                </div>
          ...
          <div className="text-center mt-8">
            <Link
              href="/trips"
              className="inline-block text-[#1a4d2e] font-semibold hover:text-[#4f8a6b] transition-colors"
            >
              View All Trips →
            </Link>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-semibold mb-4 text-[#4f8a6b]">For Individuals</h3>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-2">
                  <svg className="w-6 h-6 text-[#e67e22] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h3 className="text-2xl font-semibold mb-4 text-[#4f8a6b]">For Educational Groups</h3>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-2">
                  <svg className="w-6 h-6 text-[#e67e22] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {experts.map((expert) => (
              <div key={expert.id} className="bg-white rounded-lg shadow-md p-6 text-center">
                <div className="w-24 h-24 bg-gradient-to-br from-[#4f8a6b] to-[#1a4d2e] rounded-full mx-auto mb-4"></div>
                <h3 className="text-xl font-semibold mb-1 text-[#1a4d2e]">{expert.name}</h3>
                <p className="text-sm text-gray-600 mb-2">{expert.qualifications}</p>
                <p className="text-sm text-[#4f8a6b] font-medium mb-2">{expert.specialization}</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-sm font-semibold text-[#1a4d2e]">— Dr. Sarah Williams, University Professor</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <p className="text-gray-700 italic mb-4">
              ...
              <p className="text-sm font-semibold text-[#1a4d2e]">— Rajesh Menon, Birding Enthusiast</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <p className="text-gray-700 italic mb-4">
              ...
              <p className="text-sm font-semibold text-[#1a4d2e]">— Priya Sharma, High School Teacher</p>
            </div>
          </div>
        </div>
      </section>
